...
complete -c fishline    -n __fish_use_subcommand -s l -d "Generate a fish_prompt (Default)"
complete -c fishline    -n __fish_use_subcommand -s r -d "Generate a fish_right_prompt"
complete -c fishline -x -n __fish_use_subcommand -s x -d "Print the list of available segments and exit"
